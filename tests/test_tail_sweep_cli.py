...
def main():
    ...
    # point's renders, measured decay, and benchmark cost -- readable on
    # its own, without the terminal output that produced it.
    ...
    for expected in (
        ...
        # Measured decay against the requested RT60 (the tracer's rt60Sec).
        "Requested RT60",
        "1.000 s",
        "Measured RT60",
        # Benchmark cost.
